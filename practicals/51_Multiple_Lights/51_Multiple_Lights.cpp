...
bool load_content() {
	...
	// 20 range,0.5 power
	spots[0].set_position(vec3((-25, 5, -15)));
	...
	// Green,Direction (1, -1, 1) normalized
	// 20 range,0.5 power
	spots[0].set_position(vec3((-25, 5, -35)));
	spots[0].set_light_colour(vec4(0.0f, 1.0f, 0.0f, 1.0f));
	spots[0].set_range(20);
	spots[0].set_direction(normalize(vec3(1, -1, -1)));
	spots[0].set_power(0.5);
	...
	// Green,Direction (-1, -1, -1) normalized
	// 20 range,0.5 power
	spots[0].set_position(vec3((-10, 10, -15)));
	spots[0].set_light_colour(vec4(0.0f, 1.0f, 0.0f, 1.0f));
	spots[0].set_range(20);
	spots[0].set_direction(normalize(vec3(1, -1, -1)));
	spots[0].set_power(0.5);
	...
	// Green,Direction (-1, -1, 1) normalized
	// 20 range,0.5 power
	spots[0].set_position(vec3((-10, 10, -35)));
	spots[0].set_light_colour(vec4(0.0f, 1.0f, 0.0f, 1.0f));
	spots[0].set_range(20);
	spots[0].set_direction(normalize(vec3(1, -1, -1)));
	spots[0].set_power(0.5);
